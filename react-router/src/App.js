  ...
  return (
    <div>
      ...
      <Switch>
        ...
        {/* Note that the order of the components is important. If we put the Home-component, whose path is path="/", first, the rest components would never get a chance to render because every path start with "/" will consider matched with first component */}
        <Route path="/">
          <Home />
        </Route>
      </Switch>
